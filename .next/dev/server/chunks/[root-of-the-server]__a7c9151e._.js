...
async function PUT(req, context) {
    try {
        ...
        const leave = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].leave.findUnique({
            where: {
                id
            }
        });
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].leave.update({
            where: {
                id
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a7c9151e._.js.map